...
fn main() {
    println!("day1_2018: {}", day1_2018(read_file("day1_2018")));
    println!("day2_2018: {}", day2_2018(read_file("day2_2018")));
    println!(
        "day2_2018 part 2: {}",
        day2_2018_part2(read_file("day2_2018"))
    );
    println!("day3_2018: {}", day3_2018(read_file("day3_2018")));
    println!("day4_2018: {}", day4_2018(read_file("day4_2018")));
    println!("day5_2018: {}", day5_2018(read_file("day5_2018")));
    println!("day6_2018: {}", day6_2018(read_file("day6_2018")));
    println!(
        "day6_2018 part 2: {}",
        day6_2018_part2(read_file("day6_2018"), 10000)
    );
    println!("day7_2018: {}", day7_2018(read_file("day7_2018")));
    println!("day1_2021: {}", day1_2021(read_file("day1_2021")));
    println!(
        "day1_part2_2021: {}",
        day1_part2_2021(read_file("day1_2021"))
    );
    println!("day2_2021: {}", day2_2021(read_file("day2_2021")));
    println!(
        "day2_part2_2021: {}",
        day2_part2_2021(read_file("day2_2021"))
    );
    println!("day3_2021: {}", day3_2021(read_file("day3_2021")));
    println!(
        "day3_part2_2021: {}",
        day3_part2_2021(read_file("day3_2021"))
    );
}
